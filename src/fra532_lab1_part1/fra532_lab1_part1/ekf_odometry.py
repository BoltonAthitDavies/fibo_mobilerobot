...
class EKFOdometryNode(Node):
    ...
    def joint_states_callback(self, msg):
        ...
        self.get_logger().debug('Received joint states - implement wheel odometry here')
        pass
    ...
    def imu_callback(self, msg):
        ...
        self.get_logger().debug('Received IMU data - implement IMU update here')
        pass
    ...
    def prediction_step(self):
        ...
        self.get_logger().debug('EKF prediction step - implement prediction here')
    ...
    def measurement_update_odom(self, odom_measurement):
        ...
        self.get_logger().debug(f'Wheel odometry measurement update - implement here')
        pass
    ...
    def measurement_update_imu(self, angular_velocity):
        ...
        self.get_logger().debug(f'IMU measurement update - implement here')
        pass
